...
do
  ...
  bedtools subtract -a hg38.3.3.3plus.${triplet}.sorted.bed -b closest.1st.plus.${triplet}.to.indep.DHS.control.consensus.uniq.sorted.bed -f 1.00 -s > hg38.3.3.3plus.36_GAT_without_1st_plus_GAT_to_indep_DHS_control.bed
   rm hg38.3.3.3plus.${triplet}.sorted.bed
  ...
  bedtools subtract -a hg38.3.3.3minus.${triplet}.sorted.bed -b closest.1st.minus.${triplet}.to.indep.DHS.control.consensus.uniq.sorted.bed -f 1.00 -s > hg38.3.3.3minus.36_GAT_without_1st_minus_GAT_to_indep_DHS_control.bed
   rm hg38.3.3.3minus.${triplet}.sorted.bed
...
It appears unnecessary to plot the opposite strand 3mer relative to the anchored 3mer, as all opposite strand 3mers will convey redundant information already represented by the same strand's reverse complement 3mers. \
...
Automate analysis on all prioritized 3mers.  \
```{r engine='bash', eval=F, echo=TRUE}
```
