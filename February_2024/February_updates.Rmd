...
In previous analysis, we have prioritized some 3mers based on if they are enriched in GATA3 peaks compared to DHS regions. The enrichment is estimated by calculating differences of CDF fraction at a defined "closed" distance (16bp, and 20bp yield the same 3mer cluster). \
...
Goal: given a 3mer list, we can generate the closest 3mer coordinates to a given sets of peak summits. \


### 2nd closest 3mer to the anchor 3mer
Goal: given the closest 3mer coordinates file, we can loop thorugh a set of 3mer list and generate the 2nd closest 3mer coordinates to the provided closest 3mer coordinates. \
