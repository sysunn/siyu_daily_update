...
match.y = seq(0, 6000, by=1) # creating indices
rep.y = seq(0, 6000, by=1)
...
print(rep.y[min(which(pred1$y<=0)) - 1]) # 20; remember this number
...
The above plot plots CDFs' difference between GATA3 peak set and ctrl peak set. At 14bp, two CDFs start to be parallel/converged. \
...
The vertical dashed line indicates at which distance (log10 of 14bp) the two CDF traces became parallel. This suggests that the 3mer-GAT often binds within 15 bp of the GATA3 peak summit. \
...
The Probability Density Function Plot shows that most 2nd closest GAT are found at ~10bp to the 1st closest GAT. This suggest that in GATA ChIP peaks, 3mer GAT-GAT are often found to have fixed spacings between them. \
