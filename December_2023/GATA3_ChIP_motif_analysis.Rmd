...
# MEME-classic
meme -p 128 -oc GATA3_without_motifs_123456_78_161bpwindow_81NNN_top10000_meme_output -nmotifs 5 -objfun classic -csites 20000 -searchsize 0 -minw 4 -maxw 20 -revcomp -dna -bfile hg38_bkgrnd.txt -maxsize 100000000 without_motifs_123456_78_161bpwindow_81NNN_top10000.fasta
```


The next big step is to figure out how to deal with the previous 8 PSWMs and the expanded regions. Run previous 8 MAST on the expanded region, but first concatenate the PSWM files (from code). The coherence check is to make sure there are no hits in the central ~100 bases. \
