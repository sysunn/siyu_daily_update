...
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ssun@uchc.edu
#SBATCH -o meme181.sh_%j.out
#SBATCH -e meme181.sh_%j.err
...
# MEME-classic
meme -p 144 -oc GATA3_without_motifs_123456_78_181bpwindow_top10000_meme_output -nmotifs 10 -objfun classic -csites 20000 -searchsize 0 -minw 4 -maxw 20 -revcomp -dna -bfile hg38_bkgrnd.txt -maxsize 100000000 without_motifs_123456_78_181bpwindow_top10000.fasta
```
...
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ssun@uchc.edu
#SBATCH -o meme181_N.sh_%j.out
#SBATCH -e meme181_N.sh_%j.err
...
# MEME-classic
meme -p 144 -oc GATA3_without_motifs_123456_78_181bpwindow_141NNN_top10000_meme_output -nmotifs 10 -objfun classic -csites 20000 -searchsize 0 -minw 4 -maxw 20 -revcomp -dna -bfile hg38_bkgrnd.txt -maxsize 100000000 without_motifs_123456_78_181bpwindow_top10000_141NNN.fasta
```
