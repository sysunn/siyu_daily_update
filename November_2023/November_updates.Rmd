...
If the 3mer coordinates is <span class="highlighted2">**upstream**</span> of peak summit, `closestBed` will use the peak summit coordinates <span class="highlighted2">END</span> to subtract the 3mer coordinates <span class="highlighted2">END</span>; \
If the 3mer coordinates is <span class="highlighted2">**downstream**</span> of peak summit, `closestBed` will use the 3mer coordinates <span class="highlighted2">START</span> to subtract the peak summit coordinates <span class="highlighted2">START</span>; \
